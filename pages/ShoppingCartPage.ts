...
export class ShoppingCartPage {
    ...
    constructor(page: Page) {
        ...
        this.shoppingCartHeader=this.page.locator('div[id="content"] h1');
        this.continuebtn=this.page.locator('a[class="btn btn-default"]');
    }
    ...
    {
        return await this.shoppingCartHeader.innerText();
    }
